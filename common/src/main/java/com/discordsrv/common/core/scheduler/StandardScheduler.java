    ...
    public StandardScheduler(DiscordSRV discordSRV) {
        this(
                ...
                new DynamicCachingThreadPoolExecutor(
                        ...
                        new CountingThreadFactory(THREAD_NAME_PREFIX + "Executor #%s")
                ),
                new ScheduledThreadPoolExecutor(
                        1, /* Core pool size */
                        new CountingThreadFactory(THREAD_NAME_PREFIX + "Scheduled Executor #%s")
                ),
                new ForkJoinPool(
                        /* parallelism */
                        Math.min(
                        ...
                        new CountingForkJoinWorkerThreadFactory(THREAD_NAME_PREFIX + "ForkJoinPool Worker #%s"),
                        null,
