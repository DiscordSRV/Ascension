...
public class MuteSyncConfig extends AbstractSyncConfig<MuteSyncConfig, Game, Long> {
    ...
    public static class DiscordToMinecraftConfig {
        ...
        @Comment("The message sent to the player when they are muted in Minecraft due to a Discord mute")
        public String muteNotificationMessage = "&cYou have been muted on Discord for &f%punishment_reason% &cby &f%punishment_punisher%";
    }
    ...
    public static class MinecraftToDiscordConfig {
        ...
        public String muteReasonFormat = "Muted by %punishment_punisher% in Minecraft for %punishment_reason%, ends: %punishment_until:'YYYY-MM-dd HH:mm:ss zzz'|text:'Never'%";
