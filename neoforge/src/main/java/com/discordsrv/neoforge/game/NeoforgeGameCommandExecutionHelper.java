...
package com.discordsrv.neoforge.game;
...
public class NeoforgeGameCommandExecutionHelper implements GameCommandExecutionHelper {

    protected final NeoforgeDiscordSRV discordSRV;
    private final CommandDispatcher<CommandSourceStack> dispatcher;

    public NeoforgeGameCommandExecutionHelper(NeoforgeDiscordSRV discordSRV) {
