...
package com.discordsrv.neoforge.game.handler;
...
public class NeoforgeCommandHandler implements ICommandHandler {

    private final NeoforgeDiscordSRV discordSRV;

    public NeoforgeCommandHandler(NeoforgeDiscordSRV discordSRV) {
