...
package com.discordsrv.neoforge.console.executor;
...
public class NeoforgeCommandFeedbackExecutor implements CommandSource, Consumer<Component> {

    private final MinecraftServer server;
    private final Consumer<Component> componentConsumer;

    public NeoforgeCommandFeedbackExecutor(MinecraftServer server, Consumer<Component> componentConsumer) {
        this.server = server;
