package com.discordsrv.neoforge.util;

import com.discordsrv.neoforge.DiscordSRVNeoForgeLoader;
...
public final class ClassLoaderUtils {
    ...
    public static void withClass(String className, Consumer<Class<?>> consumer) {
        try {
            Class<?> cls = Class.forName(className, false, DiscordSRVNeoForgeLoader.getInstance().getClassloader());
