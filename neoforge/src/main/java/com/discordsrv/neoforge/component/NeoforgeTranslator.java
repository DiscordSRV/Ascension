...
package com.discordsrv.neoforge.component;
...
public class NeoforgeTranslator implements Translator {

    private final NeoforgeDiscordSRV discordSRV;

    public NeoforgeTranslator(NeoforgeDiscordSRV discordSRV) {
        this.discordSRV = discordSRV;
    }

    @Override
    public @NotNull Key name() {
        return Key.key("discordsrv", "neoforge-language");
    }
