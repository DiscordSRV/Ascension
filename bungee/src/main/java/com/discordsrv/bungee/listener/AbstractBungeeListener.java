...
public abstract class AbstractBungeeListener<E extends Event> extends AbstractModule<BungeeDiscordSRV> implements Listener {

    public AbstractBungeeListener(BungeeDiscordSRV discordSRV, Logger logger) {
