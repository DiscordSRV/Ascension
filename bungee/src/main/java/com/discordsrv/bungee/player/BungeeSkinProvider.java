...
public class BungeeSkinProvider extends AbstractModule<BungeeDiscordSRV> implements PlayerSkinProvider.Platform {

    public BungeeSkinProvider(BungeeDiscordSRV discordSRV) {
        super(discordSRV);
    }
