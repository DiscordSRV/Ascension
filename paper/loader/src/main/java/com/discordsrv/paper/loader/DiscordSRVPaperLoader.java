...
package com.discordsrv.paper.loader;
...
@SuppressWarnings("unused") // Used by Paper
public class DiscordSRVPaperLoader extends BukkitLoader {
    ...
    public @NotNull URL getJarInJarResource() {
        URL resource = getClassLoader().getResource("paper.jarinjar");
        if (resource == null) {
